    ...
    <div class="col-md-8">
        <div class="card shadow-sm p-4">
            ...
            <div class="progress-steps mb-4">
                ...
                <div class="step" data-step="2">۲. مسئول برگزاری</div>
                <div class="step" data-step="3">۳. انتظامات</div>
                <div class="step" data-step="4">۴. تیم پزشکی</div>
            ...
            <form asp-action="CompleteTournamentInfo" enctype="multipart/form-data" id="multiStepForm">
                ...
                <div class="steps-container">
                    ...
                    <div class="step-content active" data-step="1">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="MainRefereeId" id="main-referee-id"/>
                                <input type="hidden" name="MainRefereeFullName" id="main-referee-fullname"/>
                        ...
                        <div id="referees-container">
                            <div class="row g-3 referee-row">
                                <div class="col-md-5">
                                    ...
                                    <input type="hidden" name="Referees[0].Id" id="referee-0-id"/>
                                    <input type="hidden" name="Referees[0].FullName" id="referee-0-fullname"/>
                    ...
                    <div class="step-content" data-step="2">
                        <h5 class="text-primary">مسئول برگزاری</h5>
                        <hr/>

                        <!-- Organizer (Fixed Field) -->
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">نام مسئول برگزاری</label>
                                <input type="text" class="form-control national-id-input" name="OrganizerNationalId" placeholder="کد ملی کاربر" maxlength="10" data-result-id="organizer" oninput="fetchUser(this)"/>
                                <input type="hidden" name="OrganizerId" id="organizer-id"/>
                                <input type="hidden" name="OrganizerFullName" id="organizer-fullname"/>
                                <span id="organizer-confirmed" class="user-confirmed"></span>
                            </div>
                        </div>
                        ...
                        <div id="security-container">
                            <div class="row g-3 security-row">
                                <div class="col-md-5">
                                    ...
                                    <input type="hidden" name="SecurityStaff[0].Id" id="security-0-id"/>
                                    <input type="hidden" name="SecurityStaff[0].FullName" id="security-0-fullname"/>
                    ...
                    <div class="step-content" data-step="4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="MedicalManagerId" id="medical-manager-id"/>
                                <input type="hidden" name="MedicalManagerFullName" id="medical-manager-fullname"/>
                        ...
                        <div id="doctors-container">
                            <div class="row g-3 doctor-row">
                                <div class="col-md-5">
                                    ...
                                    <input type="hidden" name="Doctors[0].Id" id="doctor-0-id"/>
                                    <input type="hidden" name="Doctors[0].FullName" id="doctor-0-fullname"/>
                    ...
                    <div class="step-content" data-step="5">
                        ...
                        <div class="step-navigation mt-4">
                            ...
                            <button type="submit" class="btn btn-primary w-100">
                                <i class="fas fa-plus-circle ms-2"></i> ایجاد برگزار کننده
                            </button>
                        </div>
                    </div>
                </div>
        ...
        < script src = "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/js/all.min.js" ></script >
            ...
            const userLookupModal = new bootstrap.Modal(document.getElementById('userLookupModal'), {
                ...
                $('#multiStepForm').validate({
                    rules: {
                    MainRefereeNationalId: {nationalId: true },
                OrganizerNationalId: {nationalId: true },
                MedicalManagerNationalId: {nationalId: true },
                MainRefereeId: {required: true },
                OrganizerId: {required: true },
                ...
                OrganizerId: "لطفاً مسئول برگزاری را انتخاب کنید",
                ...
                <div class="col-md-5">
                    ...
                    <input type="hidden" name="Referees[${refereeCounter}].Id" id="referee-${refereeCounter}-id" />
                    <input type="hidden" name="Referees[${refereeCounter}].FullName" id="referee-${refereeCounter}-fullname" />
                ...
                <div class="col-md-5">
                    ...
                    <input type="hidden" name="SecurityStaff[${securityCounter}].Id" id="security-${securityCounter}-id" />
                    <input type="hidden" name="SecurityStaff[${securityCounter}].FullName" id="security-${securityCounter}-fullname" />
                ...
                <div class="col-md-5">
                    ...
                    <input type="hidden" name="Doctors[${doctorCounter}].Id" id="doctor-${doctorCounter}-id" />
                    <input type="hidden" name="Doctors[${doctorCounter}].FullName" id="doctor-${doctorCounter}-fullname" />
                ...
                $('#multiStepForm').validate().form();
            }

                $('.next-step').click(function () {
                if (currentStep < totalSteps && $('#multiStepForm').valid()) {
