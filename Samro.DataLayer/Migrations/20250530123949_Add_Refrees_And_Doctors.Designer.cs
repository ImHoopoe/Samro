...
namespace WinWin.DataLayer.Migrations
{
    ...
    [Migration("20250530123949_Add_Refrees_And_Doctors")]
    partial class Add_Refrees_And_Doctors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Samro.DataLayer.Entities.TournamentMatch.TournamentDoctor", b =>
                {
                    b.Property<int>("TournamentDoctorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TournamentDoctorId"));
                    ...
                    b.HasKey("TournamentDoctorId");

                    b.HasIndex("TournamentId");

                    b.HasIndex("UserId");

                    b.ToTable("TournamentDoctor");
                });

            modelBuilder.Entity("Samro.DataLayer.Entities.TournamentMatch.TournamentReferees", b =>
                {
                    b.Property<int>("TournamentRefereesId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TournamentRefereesId"));
            ...
            modelBuilder.Entity("Samro.DataLayer.Entities.TournamentMatch.TournamentDoctor", b =>
                {
                    b.HasOne("WinWin.DataLayer.Entities.EventModels.Tournament", "Tournament")
                        .WithMany("TournamentDoctors")
                        .HasForeignKey("TournamentId");

                    b.HasOne("WinWin.DataLayer.Entities.Roles.User", "Doctor")
                        .WithMany()
            ...
            modelBuilder.Entity("Samro.DataLayer.Entities.TournamentMatch.TournamentReferees", b =>
                {
                    ...
                    b.HasOne("WinWin.DataLayer.Entities.Roles.User", "Referee")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("WinWin.DataLayer.Entities.EventModels.Tournament", b =>
                {
                    ...
                    b.Navigation("TournamentDoctors");
